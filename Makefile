...
BINARY = stripper_qmm
SRC_FILES = ent.cpp main.cpp util.cpp
HDR_FILES = CLinkList.h ent.h util.h version.h
...
help:
	@echo Stripper supports the following make rules:
...
clean:
	@rm -rf $(BD)$(B_Q3A) $(BR)$(B_Q3A) $(BD)$(B_RTCWMP) $(BR)$(B_RTCWMP) $(BD)$(B_JKA) $(BR)$(B_JKA) $(BD)$(B_JK2) $(BR)$(B_JK2) $(BD)$(B_RTCWSP) $(BR)$(B_RTCWSP) $(BD)$(B_RTCWET) $(BR)$(B_RTCWET)
